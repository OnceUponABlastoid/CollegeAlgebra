...
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$},
  xmin=-0.5, xmax=6.5, xtick={0,2,4,6},
  ymin=-3, ymax=17, ytick={0,4,8,12,16},
  grid=both, minor tick num=1, tick style={draw=none},
]
\addplot[thick, magenta, domain=-0.2:6.2, samples=80] {2*(x-3)^2-2};
\addplot[only marks, mark=*, magenta] coordinates {(2,0) (4,0) (3,-2) (0,16)};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$},
  xmin=-10.5, xmax=2.5, xtick={-10,-8,-6,-4,-2,0,2},
  ymin=-7.5, ymax=2.5, ytick={-6,-4,-2,0,2},
  grid=both, minor tick num=1, tick style={draw=none},
]
\addplot[thick, magenta, domain=-10.3:2.3, samples=80] {-0.2*(x+4)^2+1};
\addplot[only marks, mark=*, magenta] coordinates {(-4-2.236,0) (-4+2.236,0) (-4,1) (0,-2.2)};
\end{axis}
\end{tikzpicture}
\end{center}
...
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$},
  xmin=-7.5, xmax=3.5, xtick={-6,-4,-2,0,2},
  ymin=-11.5, ymax=1.5, ytick={-10,-8,-6,-4,-2,0},
  grid=both, minor tick num=1, tick style={draw=none},
]
\addplot[thick, magenta, domain=-6.2:0.2, samples=80] {-x^2-6*x-10};
\addplot[only marks, mark=*, magenta] coordinates {(-3,-1) (0,-10)};
\end{axis}
\end{tikzpicture}
\end{center}
\end{enumerate}
