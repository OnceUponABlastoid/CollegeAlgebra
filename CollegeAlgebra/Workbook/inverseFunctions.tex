...
\begin{problem}
The graph of $h(x)$ is shown below (domain $[-5,3]$).
...
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$},
  xmin=-6, xmax=5, xtick={-5,-4,...,4},
  ymin=-6, ymax=5, ytick={-5,-4,...,4},
  grid=both, minor tick num=0, tick style={draw=none},
]
\addplot[thick, blue] coordinates {(-5,-3) (-1,-1) (0,3) (3,4)};
\addplot[only marks, mark=*, blue] coordinates {(-5,-3) (-1,-1) (0,3) (3,4)};
\node[blue] at (axis cs:-3,2) {$h(x)$};
\addplot[thick, red, dashed] coordinates {(-3,-5) (-1,-1) (3,0) (4,3)};
\addplot[only marks, mark=*, red] coordinates {(-3,-5) (-1,-1) (3,0) (4,3)};
\node[red] at (axis cs:2,-3) {$h^{-1}(x)$};
\addplot[thin, dashed, black, domain=-5.8:4.8] {x};
\end{axis}
\end{tikzpicture}
\end{center}
