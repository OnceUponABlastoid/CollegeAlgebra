...
\begin{problem}
For each function: describe the transformations of the parent function, find the domain and range, state the horizontal asymptote, and sketch the graph.
\begin{enumerate}
  \item[(a)] $q(x) = 3^{x-4}-1$
  \medskip
  \item[(b)] $f(x) = -4^{x-2}+1$
...
\begin{axis}[
  ...
  xlabel={$x$}, ylabel={$y$},
  xmin=-3.5, xmax=7.5, xtick={-2,0,2,4,6},
  ymin=-4.5, ymax=6.5, ytick={-4,-2,0,2,4,6},
  grid=both, minor tick num=1, tick style={draw=none},
]
\addplot[thick, magenta, domain=-3.5:1.7, samples=80] {3^x};
\addplot[only marks, mark=*, magenta] coordinates {(0,1) (-1,0.333) (1,3)};
\node[magenta] at (axis cs:2,4.5) {$f(x)=3^x$};
\addplot[thick, blue, domain=-3.5:5.8, samples=80] {3^(x-4)-1};
\addplot[only marks, mark=*, blue] coordinates {(4,0) (3,-0.667) (5,2)};
\node[blue] at (axis cs:1.5,-2.5) {$q(x)=3^{x-4}-1$};
\addplot[dashed, thin, blue] coordinates {(-3.5,-1) (7.5,-1)};
\end{axis}
\end{tikzpicture}
\end{center}
...
\addplot[thick, magenta, domain=-4.5:1.23, samples=80] {4^x};
\addplot[only marks, mark=*, magenta] coordinates {(0,1) (-1,0.25) (1,4)};
\node[magenta] at (axis cs:3,3.5) {$g(x)=4^x$};
\addplot[thick, blue, domain=-4.5:3.33, samples=80] {-4^(x-2)+1};
\addplot[only marks, mark=*, blue] coordinates {(2,0) (1,0.75) (3,-3)};
\node[blue] at (axis cs:3.5,3) {$f(x)=-4^{x-2}+1$};
\addplot[dashed, thin, blue] coordinates {(-4.5,1) (6.5,1)};
\end{axis}
\end{tikzpicture}
\end{center}
...
\addplot[thick, magenta, domain=-1.55:6.5, samples=80] {(1/3)^x};
\addplot[only marks, mark=*, magenta] coordinates {(0,1) (-1,3) (1,0.333)};
\node[magenta] at (axis cs:4,3.5) {$f(x)=\!\left(\tfrac{1}{3}\right)^x$};
\addplot[thick, blue, domain=-2.92:6.5, samples=80] {(1/3)^(x+1)-3};
\addplot[only marks, mark=*, blue] coordinates {(-1,-2) (-2,0) (0,-2.667)};
\node[blue] at (axis cs:3,-1.5) {$g(x)=\!\left(\tfrac{1}{3}\right)^{x+1}\!-3$};
\addplot[dashed, thin, blue] coordinates {(-4.5,-3) (6.5,-3)};
\end{axis}
\end{tikzpicture}
\end{center}
