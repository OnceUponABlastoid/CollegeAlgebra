...
%%
\license{CC: 0}
\author{James Sutherland and Amit Vutha}
...
\providecommand{\AND}{\;\text{AND}\;}
\providecommand{\OR}{\;\text{OR}\;}

%%  TikZ: reusable number line dots
\providecommand{\closeddot}[1]{\filldraw[blue] (#1,0) circle (3.5pt);}
\providecommand{\opendot}[1]{\draw[blue,fill=white,thick] (#1,0) circle (3.5pt);}
